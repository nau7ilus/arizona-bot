...
exports.supportSettings = {
  ...
  '772869388147490846': {
    ...
    phrases: {
      mainMessage:
        'Здесь вы можете задать вопрос агентам поддержки касательно правил или поведения в Discord-сервере Winslow.\n' +
        'С правилами обращениями к агенту поддержки можете ознакомиться в канале <#772869389929676854>',
      ticketMessage:
  ...
  // Test server
  '785925511788494868': {
    moderators: ['785925550668513342'],
    channelID: '785925613696581632',
    deleteAfter: 60 * 1000,
    logChannel: '786277161472098326',
    phrases: {
      mainMessage:
        'Здесь вы можете задать вопрос агентам поддержки касательно правил или поведения в Discord-сервере Winslow.\n' +
        'С правилами обращениями к агенту поддержки можете ознакомиться в канале <#772869389929676854>',
    ...
    categories: {
      active: '785925631765774357',
      hold: '785925645888127028',
      close: '785925664397459477',
    },
  },
};
